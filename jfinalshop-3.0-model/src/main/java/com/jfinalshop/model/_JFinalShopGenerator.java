...
public class _JFinalShopGenerator {
	...
	public static DataSource getDataSource() {
		String jdbcUrl = "jdbc:mysql://192.168.9.43:3306/jfinalshop?useUnicode=true&characterEncoding=UTF-8";
		String user = "root";
	...
	public static void main(String[] args) {
		...
		// base model 文件保存路径
		String baseModelOutputDir = "/Users/lihongyuan/git/JFinalShop/jfinalshop-model/src/main/java/com/jfinalshop/model/base";
