...
public class ExcelView {
	 ...
	 *            response
	 */
	public void buildExcelDocument(HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
		//AssertUtil.notEmpty(properties);
		HSSFSheet sheet;
