 ...
 */
package com.jfinalshop.plugin.captcha.filter.predefined;
...
import com.jfinalshop.plugin.captcha.filter.AbstractFilterFactory;
import com.jfinalshop.plugin.captcha.filter.library.DoubleRippleImageOp;
