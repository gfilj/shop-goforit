 ...
 * This class encapsulates the logic of checking whether a user is already
 * authenticated in the system while subclasses are required to perform specific
 * logic for unauthenticated requests.
 *
 * @since 0.9
 */
