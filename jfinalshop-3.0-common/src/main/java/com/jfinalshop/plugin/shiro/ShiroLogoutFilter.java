...
public class ShiroLogoutFilter extends AdviceFilter {
	...
	/**
	 * Returns the currently executing {@link org.apache.shiro.subject.Subject}.
	 * This implementation merely defaults to calling {@code SecurityUtils.}
	 ...
	 * {@link org.apache.shiro.web.util.WebUtils#issueRedirect(javax.servlet.ServletRequest, javax.servlet.ServletResponse, String)
	 * issueRedirect(request,response,redirectUrl)}.
	 *
	 * @param request
	 *            the incoming Servlet request
	 ...
	 * {@code Subject.}
	 * {@link org.apache.shiro.subject.Subject#getSession(boolean)
	 * getSession(false)} method to ensure a new session isn't created
	 * unnecessarily. If a session would be created, it will be immediately
	 * stopped after logout, not providing any value and unnecessarily taxing
	 * session infrastructure/resources.
	 *
	 * @param request
	 *            the incoming Servlet request
	 * @param response
