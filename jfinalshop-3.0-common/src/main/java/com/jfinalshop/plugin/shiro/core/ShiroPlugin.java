...
import com.jfinalshop.plugin.shiro.core.handler.AuthenticatedAuthzHandler;
import com.jfinalshop.plugin.shiro.core.handler.AuthzHandler;
import com.jfinalshop.plugin.shiro.core.handler.CompositeAuthzHandler;
import com.jfinalshop.plugin.shiro.core.handler.GuestAuthzHandler;
import com.jfinalshop.plugin.shiro.core.handler.PermissionAuthzHandler;
import com.jfinalshop.plugin.shiro.core.handler.RoleAuthzHandler;
import com.jfinalshop.plugin.shiro.core.handler.UserAuthzHandler;
...
public class ShiroPlugin implements IPlugin {
	...
	// this.appliedPaths.put(Permission.getStr("auth_url"),
	// Permission.getStr("auth_key"));
	// }
	// }
	// }
	// }
