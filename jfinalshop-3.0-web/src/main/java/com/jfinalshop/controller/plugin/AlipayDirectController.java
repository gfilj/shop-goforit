 ...
 * 
 */
@ControllerBind(controllerKey = "/admin/paymentPlugin/alipayDirect")
public class AlipayDirectController extends BaseAdminController {

	private AlipayDirectPlugin alipayDirectPlugin = new AlipayDirectPlugin();
	...
	public void setting() {
		...
		render("/plugin/alipayDirect/setting.html");
	}
